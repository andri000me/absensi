...
$strParam="caption=Grafik Keterlambatan Guru - Tahun $tahun; decimalPrecision=0";
...
$laporan_telat=mysql_query("select * from absensi_guru where bulan='$t_bulan' and terlambat='y'");
