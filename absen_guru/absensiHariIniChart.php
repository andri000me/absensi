...
$hadir = mysql_query("SELECT * FROM absensi_guru WHERE keterangan='h' and tanggal='$tanggal'");
$alpa = mysql_query("SELECT * FROM absensi_guru WHERE keterangan='a' and tanggal='$tanggal'");
$sakit = mysql_query("SELECT * FROM absensi_guru WHERE keterangan='s' and tanggal='$tanggal'");
$izin = mysql_query("SELECT * FROM absensi_guru WHERE keterangan='i' and tanggal='$tanggal'");
...
$strParam="caption=Persentasi Kehadiran Guru Hari Ini ($tanggal);decimalPrecision=0";
