...
$query = "SELECT guru.nip, guru.nama, absensi_guru.tanggal, absensi_guru.waktu, absensi_guru.keterangan FROM absensi_guru, guru where absensi_guru.guru_nip=guru.nip and absensi_guru.bulan='$bulan' order by absensi_guru.tanggal";
...
$judul = "Laporan Data Guru Bulan $bulan_report";
$header = array(
