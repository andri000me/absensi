<?php
	...
	$chart->setTitle("Persentasi Absensi Karyawan");
	$chart->render("libchart/demo/generated/lap_chart_karyawan.png");
?>
...
<body>
	...
	<img alt="Pie chart"  src="libchart/demo/generated/lap_chart_karyawan.png" style="border: 1px solid gray;"/>
