...
<body>
			...
			<div class="content-box">
				<div class="box-header clear">
					...
					<h2>Laporan Karyawan Terlambat</h2>
				</div>
...
<?php //----------------------------------------------------------------------------------------------------------------------------?>
					...
					<?php
						...
						$query = mysql_query("select * from absensi_karyawan where keterangan='h' and terlambat='y' and bulan='$tanggal_bulan' limit $offset, $rec_limit");
						$qc = mysql_query("select count(*) as tot3 from absensi_karyawan where keterangan='h' and terlambat='y' and bulan='$tanggal_bulan'");
					
					
					?>
										
					<table>
					<form method="post" action="index.php?page=laporan_telat_karyawan">
						...
						<div class="dataTables_paginate paging_full_numbers">
							<span>
								<?
									...
									for($i=1;$i<=$jumhal;$i++){
								?>
								<a href='index.php?page=laporan_telat_karyawan&page_laporan=<?php echo $i; ?>'><span class="paginate_button"><?=$i?></span></a>
								<?
									}
								?>
							</span>
