...
<div id='downloadini'>
<div id="downloadkiri">
<form method="post" action="absen_karyawan/download.php">
...
<form method="post" action="absen_karyawan/download_proses.php" target=_blank>
...
<?php //----------------------------------------------------------------------------------------------------------------------------?>	
					...
					<?php
						...
						$query = mysql_query("select * from absensi_karyawan where bulan='$tanggal_bulan' ORDER BY tanggal limit $offset, $rec_limit");
						$qc = mysql_query("select count(*) as tot3 from absensi_karyawan where bulan='$tanggal_bulan'");
						$hadir = mysql_query("SELECT * FROM absensi_karyawan where keterangan='h' and bulan='$tanggal_bulan'");
						$alpa = mysql_query("SELECT * FROM absensi_karyawan where keterangan='a' and bulan='$tanggal_bulan'");
						$sakit = mysql_query("SELECT * FROM absensi_karyawan where keterangan='s' and bulan='$tanggal_bulan'");
						$izin = mysql_query("SELECT * FROM absensi_karyawan where keterangan='i' and bulan='$tanggal_bulan'");
						...
						<div class="dataTables_paginate paging_full_numbers">
							<span>
								<?
									...
									for($i=1;$i<=$jumhal;$i++){
								?>
								<a href='index.php?page=laporan_karyawan&page_laporan=<?php echo $i; ?>'><span class="paginate_button"><?=$i?></span></a>
								<?
									}
								?>
							</span>
