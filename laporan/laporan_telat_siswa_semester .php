...
<?php //----------------------------------------------------------------------------------------------------------------------------?>				
				...
				<?php if($_SESSION['admin']){ $query_kelas=mysql_query("select*from kelas order by Nama_Kelas"); ?>Pilih Siswa :
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------ -->
					...
					<?php
						...
						$query = mysql_query("select * from absensi_siswa where kd_kelas='$id_kelas' and bulan='$tanggal_bulan' ORDER BY tanggal limit $offset, $rec_limit");
						$qc = mysql_query("select count(*) as tot3 from absensi_siswa where kd_kelas='$id_kelas' and bulan='$tanggal_bulan'");
						$hadir = mysql_query("SELECT * FROM absensi_siswa WHERE kd_kelas='$id_kelas' and keterangan='h' and bulan='$tanggal_bulan'");
