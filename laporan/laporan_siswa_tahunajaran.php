...
<body>
			...
			<div class="content-box">
				<div class="box-header clear">
					...
					<h2>Laporan Absensi Siswa Periode Tahun Ajaran</h2>
				</div>
				
				<div class="box-body clear">
<?php //----------------------------------------------------------------------------------------------------------------------------?>				
				<form method="post" action="index.php?page=absen_siswa_tahunajaran">
		...
		<ul class='download'>
			<li>
				<form method="post" action="laporan/download/download_xl.php">
					<input type="hidden" name="jenis_laporan" value="tahun_ajaran">
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------ -->
					...
					<?php
						...
						$query = mysql_query("select * from absensi_siswa where no_siswa='$nis_siswa' and tahun_ajaran='$tahun_ajaran' and in_out='$in_out' ORDER BY tanggal limit $offset, $rec_limit");
						
						
						
						$qc = mysql_query("select count(*) as tot3 from absensi_siswa where no_siswa='$nis_siswa' and tahun_ajaran='$tahun_ajaran' and in_out='$in_out'");
						$hadir = mysql_query("SELECT * FROM absensi_siswa WHERE keterangan='h' and no_siswa='$nis_siswa' and tahun_ajaran='$tahun_ajaran' and in_out='$in_out'");
						$alpa = mysql_query("SELECT * FROM absensi_siswa WHERE keterangan='a' and no_siswa='$nis_siswa' and tahun_ajaran='$tahun_ajaran' and in_out='$in_out'");
						$sakit = mysql_query("SELECT * FROM absensi_siswa WHERE keterangan='s' and no_siswa='$nis_siswa' and tahun_ajaran='$tahun_ajaran' and in_out='$in_out'");
						$izin = mysql_query("SELECT * FROM absensi_siswa WHERE  keterangan='i' and no_siswa='$nis_siswa' and tahun_ajaran='$tahun_ajaran' and in_out='$in_out'");
						...
						<div class="dataTables_paginate paging_full_numbers">
							<span>
								<?
									...
									for($i=1;$i<=$jumhal;$i++){
								?>
								<a href='index.php?page=absen_siswa_tahunajaran&page_laporan=<?php echo $i; ?>&tahun_ajaran=<?php echo $tahun_ajaran; ?>&in_out=<?php echo $in_out; ?>&nis_siswa=<?php echo $nis_siswa; ?>'><span class="paginate_button"><?=$i?></span></a>
								<?
									}
								?>
							</span>
