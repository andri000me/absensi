...
<link rel="shortcut icon" href="master/logo/<?php print $array3["logo"];?>" type="shortcut icon" />
			...
			<div class="content-box">
				<div class="box-body clear">
					<?php
						...
						$master = array("Guru","Kelas","Siswa","Karyawan","Jurusan","Libur");
						if($_GET["page"]){
						@$p		= $_GET["page"];
						$q 		= mysql_query("select *from kelas where id='$p'");
				...
				<div class='bodyfooter'><label>© SMKN 10 JAKARTA. Support By : Aziz Hardaya, Greenda Soundi Rabia, Ivans Ardiansyah, Jefferson Hendrik Willem, Muhammad Fariz</label></div>
