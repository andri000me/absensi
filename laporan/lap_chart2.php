<?php
	...
	$chart->setTitle("Jumlah Kehadiran $nama_kelass");
	$chart->render("libchart/demo/generated/lap_chart2.png");
?>
...
<body>
	<img alt="Vertical bars chart" src="libchart/demo/generated/lap_chart2.png" style="border: 1px solid gray;"/>
</body>
</html>